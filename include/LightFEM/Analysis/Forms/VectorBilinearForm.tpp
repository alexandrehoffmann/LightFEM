...
#ifndef VECTOR_BILINEAR_FORM_TPP
#define VECTOR_BILINEAR_FORM_TPP
...
VectorBilinearForm::VectorBilinearForm(const VectorFunctionSpace *Uh, const VectorFunctionSpace *Vh, Form form) :
	m_Uh(Uh),
	m_Vh(Vh)
{
...
template<typename Form>
VectorBilinearForm::VectorBilinearForm(const VectorFunctionSpace *Uh, const VectorFunctionSpace *Vh, Form form, MPI_Comm com) : 
	m_Uh(Uh),
	m_Vh(Vh)
{
	if (Uh->getMesh() != Vh->getMesh()) { throw std::invalid_argument("The two function space must be defined on the same mesh"); }
...
template<typename Form>
CpxVectorBilinearForm::CpxVectorBilinearForm(const VectorFunctionSpace *Uh, const VectorFunctionSpace *Vh, Form form) :
	m_Uh(Uh),
	m_Vh(Vh)
{
	if (Uh->getMesh() != Vh->getMesh()) { throw std::invalid_argument("The two function space must be defined on the same mesh"); }
...
template<typename Form>
CpxVectorBilinearForm::CpxVectorBilinearForm(const VectorFunctionSpace *Uh, const VectorFunctionSpace *Vh, Form form, MPI_Comm com) : 
	m_Uh(Uh),
	m_Vh(Vh)
{
	if (Uh->getMesh() != Vh->getMesh()) { throw std::invalid_argument("The two function space must be defined on the same mesh"); }
...
#endif // VECTOR_BILINEAR_FORM_TPP
