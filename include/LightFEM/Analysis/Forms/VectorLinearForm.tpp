...
#ifndef VECTOR_LINEAR_FORM_TPP
#define VECTOR_LINEAR_FORM_TPP
...
VectorLinearForm::VectorLinearForm(const VectorFunctionSpace *Vh, Form form) :
	m_Vh(Vh),
...
template<typename Form>
VectorLinearForm::VectorLinearForm(const VectorFunctionSpace *Vh, Form form, MPI_Comm com) : 
	m_Vh(Vh),
	m_coefs(Vh->getNBasisFunction(), 0.0)
{
...
template<typename Form>
CpxVectorLinearForm::CpxVectorLinearForm(const VectorFunctionSpace *Vh, Form form) :
	m_Vh(Vh),
	m_coefs(Vh->getNBasisFunction(), 0.0)
{
	#pragma omp parallel
...
template<typename Form>
CpxVectorLinearForm::CpxVectorLinearForm(const VectorFunctionSpace *Vh, Form form, MPI_Comm com) :
	m_Vh(Vh),
	m_coefs(Vh->getNBasisFunction(), 0.0)
{
