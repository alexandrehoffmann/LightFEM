...
VectorTestFunction::VectorTestFunction(const VectorFunctionSpace* functionSpace, const Element* element, const int locId) :
...
VectorTestFunction::VectorTestFunction(const VectorTestFunction& other) :
...
GradVectorTestFunction::GradVectorTestFunction(const VectorTestFunction& testFunction) :
