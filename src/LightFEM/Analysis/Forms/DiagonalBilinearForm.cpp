...
void DiagonalBilinearForm::setZeroOnBoundary(std::initializer_list<std::string> boundaryNames)
{
...
void CpxDiagonalBilinearForm::setZeroOnBoundary(std::initializer_list<std::string> boundaryNames)
{
	const Mesh* mesh = m_Vh->getMesh();
